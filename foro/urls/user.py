...
urlpatterns = patterns('foro.views.user',
                       url(r'^login/$', 'custom_login', {'template_name': 'foro/user/login.html'}, name='user-login'),
                       ...
                       url(r'^password-reset/$',
                           ...
                           {'template_name': 'foro/user/password_reset_form.html',
                            ...
                            'subject_template_name': 'foro/user/'
                            'password_reset_subject.txt',
                            'post_reset_redirect': reverse_lazy('foro:password-reset-done')},
                           name='password-reset'),
                       url(r'^password-reset/done/$',
                           password_reset_done,
                           {'template_name': 'foro/user/password_reset_done.html', },
                           name='password-reset-done'),
                       url(r'^reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[\w\-]+)/$', password_reset_confirm,
                           {'template_name': 'foro/user/password_reset_confirm.html',
                            'post_reset_redirect': reverse_lazy('foro:password-reset-complete')},
                           name='password-reset-confirm'),
                       url(r'^reset/done/$',
                           password_reset_complete,
                           {'template_name': 'foro/user/password_reset_complete.html', },
