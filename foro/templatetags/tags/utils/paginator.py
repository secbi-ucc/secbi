...
from foro.utils.paginator.yt_paginator import YTPaginator
...
@register.inclusion_tag("foro/paginator/_yt_paginator.html", takes_context=True)
...
@register.inclusion_tag("foro/paginator/_paginator.html", takes_context=True)
