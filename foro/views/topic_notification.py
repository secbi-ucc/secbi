...
from foro.utils.paginator.infinite_paginator import paginate

from foro.models.topic_notification import TopicNotification
from foro.forms.topic_notification import NotificationForm, NotificationCreationForm
...
def notification_list(request):
    notifications = TopicNotification.objects.for_access(request.user)
    return render(request, 'foro/topic_notification/list.html', {'notifications': notifications, })
