...
from foro.models.topic_poll import TopicPoll
from foro.forms.topic_poll import TopicPollChoiceFormSet, TopicPollForm, TopicPollVoteManyForm
from foro.signals.topic_poll import topic_poll_pre_vote, topic_poll_post_vote
...
def poll_update(request, pk):
    ...
    return render(request, 'foro/topic_poll/poll_update.html', {'form': form, 'formset': formset})
...
def poll_close(request, pk):
    ...
    return render(request, 'foro/topic_poll/poll_close.html', {'poll': poll, })
