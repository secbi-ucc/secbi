...
def topic_publish(request, category_id=None):
    ...
    return render(request, 'foro/topic/topic_publish.html', {'form': form, 'cform': cform,
...
def topic_moderate(request, pk, value, remove=False, lock=False, pin=False):
    ...
    return render(request, 'foro/topic/topic_moderate.html', {'topic': topic, })
...
def topics_active(request):
    ...
    return render(request, 'foro/topic/topics_active.html', {'categories': categories,
                                                               'topics': topics})
