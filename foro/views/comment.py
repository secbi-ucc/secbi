...
from foro.utils import paginator, markdown
from foro.utils.decorators import moderator_required
from foro.utils import json_response, render_form_errors

from foro.models.comment import Comment
from foro.forms.comment import CommentForm, CommentMoveForm, CommentImageForm
from foro.signals.comment import comment_posted, comment_pre_update, comment_post_update, comment_moved
...
def comment_publish(request, topic_id, pk=None):
    ...
    return render(request, 'foro/comment/comment_publish.html', {'form': form, 'topic': topic})
...
def comment_update(request, pk):
    ...
    return render(request, 'foro/comment/comment_update.html', {'form': form, })
...
def comment_delete(request, pk, remove=True):
    ...
    return render(request, 'foro/comment/comment_moderate.html', {'comment': comment, })
