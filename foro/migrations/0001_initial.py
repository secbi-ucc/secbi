    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', foro.utils.models.AutoSlugField(db_index=False, populate_from=b'username', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', foro.utils.models.AutoSlugField(db_index=False, populate_from=b'title', blank=True)),
                ...
                ('parent', models.ForeignKey(verbose_name='category parent', blank=True, to='foro.Category', null=True)),
            ],
            options={
                'ordering': ['title'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.OneToOneField(to='foro.Comment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_html', models.TextField(verbose_name='comment html')),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('comment_fk', models.ForeignKey(verbose_name='original comment', to='foro.Comment')),
            ],
            options={
                'ordering': ['-date'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('comment', models.ForeignKey(related_name=b'comment_likes', to='foro.Comment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.ForeignKey(to='foro.Comment')),
                ('user', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-date'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.ForeignKey(blank=True, to='foro.Comment', null=True)),
            ],
            options={
                'ordering': ['-date'],
        ...
        migrations.CreateModel(
            name='TopicPoll',
            fields=[
                ('topic', models.OneToOneField(related_name=b'poll', primary_key=True, serialize=False, to='foro.Topic', verbose_name='topic')),
                ('date', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poll', models.ForeignKey(related_name=b'choices', verbose_name='poll', to='foro.TopicPoll')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('choice', models.ForeignKey(related_name=b'votes', verbose_name='poll choice', to='foro.TopicPollChoice')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('topic', models.ForeignKey(related_name=b'topics_private', to='foro.Topic')),
                ('user', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-date'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic', models.ForeignKey(to='foro.Topic')),
        ...
        migrations.AddField(
            ...
            name='topic',
            field=models.ForeignKey(to='foro.Topic'),
