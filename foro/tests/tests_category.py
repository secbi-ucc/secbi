...
class CategoryViewTest(TestCase):
    ...
    def test_category_detail_view(self):
        ...
        response = self.client.get(reverse('foro:category-detail', kwargs={'pk': self.category_1.pk,
    ...
    def test_category_detail_view_invalid_category(self):
        ...
        invalid category
        """
        response = self.client.get(reverse('foro:category-detail', kwargs={'pk': str(99), }))
    ...
    def test_category_detail_subcategory(self):
        ...
        response = self.client.get(reverse('foro:category-detail', kwargs={'pk': self.subcategory_1.pk,
