...
from foro.utils.forms import NestedModelChoiceField
from foro.utils.timezone import TIMEZONE_CHOICES
from foro.utils.decorators import moderator_required, administrator_required
from foro.utils.user.tokens import UserActivationTokenGenerator, UserEmailChangeTokenGenerator
from foro.utils.user.email import send_activation_email, send_email_change_email, sender
from foro.utils.user import email

from foro import utils as foro_utils
from foro.templatetags.tags.utils import time as ttags_utils
from . import utils as test_utils
from foro.templatetags.tags.utils.messages import render_messages
from foro.utils.markdown import Markdown, quotify
...
class UtilsTests(TestCase):
    ...
    def test_render_form_errors(self):
        ...
        res = foro_utils.render_form_errors(MockForm())
...
class UtilsMarkdownTests(TestCase):
    ...
    def test_markdown_emoji(self):
        ...
        md = Markdown(escape=True, hard_wrap=True)
        comment_md = md.render(comment)
        self.assertEqual(comment_md, '<p><img class="comment-emoji" src="%(static)sforo/emojis/airplane.png">, '
                                     '<img class="comment-emoji" src="%(static)sforo/emojis/8ball.png"> '
