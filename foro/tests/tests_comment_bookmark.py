...
from foro.models.comment_bookmark import CommentBookmark, topic_viewed
from foro.forms.comment_bookmark import BookmarkForm
...
class CommentBookmarkViewTest(TestCase):
    ...
    def test_bookmark_create(self):
        ...
        response = self.client.post(reverse('foro:bookmark-create', kwargs={'topic_id': self.topic.pk, }),
