...
from foro.models.comment_history import CommentHistory, comment_pre_update, comment_post_update
...
class CommentHistoryViewTest(TestCase):
    ...
    def test_comment_history_detail(self):
        ...
        utils.login(self)
        response = self.client.get(reverse('foro:comment-history', kwargs={'comment_id': comment.pk, }))
