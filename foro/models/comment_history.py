...
from foro.signals.comment import comment_pre_update, comment_post_update


@python_2_unicode_compatible
class CommentHistory(models.Model):

    comment_fk = models.ForeignKey('foro.Comment', verbose_name=_("original comment"))
    ...
    def get_absolute_url(self):
        return reverse('foro:comment-history', kwargs={'pk': str(self.id), })
