...
from foro.managers.topic_notifications import TopicNotificationManager
...
class TopicNotification(models.Model):
    ...
    topic = models.ForeignKey('foro.Topic')
    comment = models.ForeignKey('foro.Comment', null=True, blank=True)
